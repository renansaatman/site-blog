...
export function FeatureSection() {
  return (
    <section className="container bg-gray-700 grid gap-6 md:grid-cols-2 pt-10 pb-[72px] md:pt-20 md:pb-[120px]">
      ...
      <div className="col-span-full flex flex-col gap-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
          <div className="flex flex-col gap-4">
            ...
            <Button className="hidden rounded-full mt-4 md:mt-auto md:flex w-fit" asChild>
